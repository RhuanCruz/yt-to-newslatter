...
export const SignInPage: React.FC<SignInPageProps> = ({
  title = <span className="font-light text-foreground tracking-tighter">Yt to newsletter</span>,
  description = "Transforme seu canal ou seus canais favoritos em uma newsletter personalizada.",
  heroImageSrc,
  testimonials = [],
  onSignIn,
  onGoogleSignIn,
